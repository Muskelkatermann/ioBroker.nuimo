...
class Device extends EventEmitter {
    ...
    setLEDMatrix (matrixData, brightness, timeout, fade) {
        if (this._LEDCharacteristic) {
            ...
            if (matrixData instanceof Buffer) {
                ...
                this._LEDArrayToBuffer(matrixData,fade).copy(buf);
            }
    ...
    _LEDArrayToBuffer (arr,fade) {
        ...
        for (let i = 0; i < 11; i++) {
            ...
            if(i==10)
			{
				if(fade)
				{
					buf[i] = parseInt("0000000"+arr[80], 2);
				}else
				{
					buf[i] = parseInt("0001000"+arr[80], 2);
				}
			}else
			{
